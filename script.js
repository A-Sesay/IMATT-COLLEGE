const firebaseConfig = {
  apiKey: 'AIzaSyCgUs5Ba99g0d93JBWYwI24UlWAxRSjc0M',
  authDomain: 'imatt-college-erp.firebaseapp.com',
  projectId: 'imatt-college-erp',
  storageBucket: 'imatt-college-erp.firebasestorage.app',
  messagingSenderId: '300130389088',
  appId: '1:300130389088:web:f5a7cbf1191a59156c0705',
  measurementId: 'G-30S868J4S9'
};
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (loginForm) {
    loginForm.addEventListener('submit', (event) => {
      ...
      const isLocalAdmin = enteredEmail === adminCredentials.email.toLowerCase() && enteredPassword === adminCredentials.password;
